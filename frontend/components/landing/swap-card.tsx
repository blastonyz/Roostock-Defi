  ...
  if (!mounted) {
    return (
      <div className="mt-6 rounded-2xl border border-cyan-400/20 bg-slate-950/80 p-5 backdrop-blur-sm">
        ...
        <div className="mt-4 h-24 rounded-xl border border-cyan-400/15 bg-slate-900/50" />
        <div className="mt-4 h-10 rounded-lg bg-slate-900/60" />
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          <div className="h-16 rounded-md bg-slate-900/60" />
          <div className="h-16 rounded-md bg-slate-900/60" />
        </div>
      </div>
    );
  ...
  return (
    <div className="mt-6 rounded-2xl border border-cyan-400/20 bg-slate-950/80 p-5 backdrop-blur-sm">
      ...
      <div className="grid items-stretch gap-4 lg:grid-cols-2">
        <div className="h-full rounded-xl border border-cyan-400/15 bg-slate-900/50 p-3">
        ...
        <div className="h-full rounded-xl border border-cyan-400/15 bg-slate-900/40 p-4">
          <div className="mb-4 grid gap-2 sm:grid-cols-2">
            <button
              onClick={() => setSwapDirection("WRBTC_TO_DOC")}
              disabled={swapLoading || wrapLoading || quoteLoading}
              className={`rounded-md border px-3 py-2 text-xs font-semibold transition disabled:cursor-not-allowed disabled:opacity-50 ${
                fromToken === "WRBTC"
          ...
          <div className="mt-4 space-y-3">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <button
                ...
                className="rounded-lg border border-cyan-400/30 bg-slate-900 px-4 py-2 text-sm font-semibold text-cyan-200 transition hover:border-cyan-300 disabled:cursor-not-allowed disabled:opacity-50 sm:min-w-[140px]"
              >
              ...
              <button
                ...
                disabled={!canSwap}
                className="btn-gradient-cyan rounded-lg px-5 py-2 text-sm font-semibold text-slate-950 transition disabled:cursor-not-allowed disabled:opacity-50 sm:min-w-[140px]"
              >
